...
public class SecurityConfig {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .csrf().disable()
                .formLogin().disable() // If you don't want a testing use formLogin()
                .httpBasic(Customizer.withDefaults()) // *** If you wanna test api use httpBasic() because it's easier than when do unit testing
